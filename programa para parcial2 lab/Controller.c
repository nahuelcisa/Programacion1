...
int controller_isEmpty(LinkedList* pArrayListEmployee){
    ...
    int retorno;
        ...
        if(pArrayListEmployee != NULL){
            retorno = ll_isEmpty(pArrayListEmployee);
        }
    return retorno;
}
...
int controller_addEmployeePush(LinkedList* pArrayListEmployee)
{
    ...
    if(pArrayListEmployee != NULL){
        ...
        printf("        ********        AGREGAR EMPLEADO EN INDICE EN ESPECIFICO       ********       \n\n\n");
...
LinkedList* controller_CloneList(LinkedList* pArrayListEmployee){
    ...
    if(pArrayListEmployee != NULL){
        ...
        lista2 = ll_clone(pArrayListEmployee);
    }
...
int controller_Contains(LinkedList* pArrayListEmployee){
    ...
    if(pArrayListEmployee != NULL){
        ...
        aux = test_getNode(pArrayListEmployee,indice);

        if(ll_contains(pArrayListEmployee,aux->pElement)){
...
int controller_ContainsAll(LinkedList* pArrayListEmployee, LinkedList* pArrayListEmployee2){
    ...
    if(pArrayListEmployee != NULL && pArrayListEmployee2 != NULL){


        if(ll_containsAll(pArrayListEmployee,pArrayListEmployee2)){
